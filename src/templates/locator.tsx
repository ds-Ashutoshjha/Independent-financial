  ...
  return {
    title: `${
      document.c_meta_title
        ? document.c_meta_title
        : `Independent Financial Near Me - Independent Financial Branch Locator Here.`
    }`,
    charset: "UTF-8",
        ...
        attributes: {
          ...
          content: `${
            document.c_meta_description
              ? document.c_meta_description
              : `View Independent Financial near you today at Independent Financial. We stock high-quality, robust products at competitive rates.`
          }`,
        },
      },
      ...
      },
      {
        ...
        attributes: {
          ...
          content: `${
            document.c_meta_title
              ? document.c_meta_title
              : `Independent Financial Near Me - Find Independent Financial Locator Here.`
          }`,
        },
      },
      {
      ...
      },
      {
        ...
        attributes: {
          ...
          content: `${
            document.c_meta_title
              ? document.c_meta_title
              : `Independent Financial Near Me - Find Independent Financial Branch Locator Here.`
          }`,
        },
      },
      {
